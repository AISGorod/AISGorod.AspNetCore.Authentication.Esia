...
- Добавлен параметр `IEsiaOptions.SkipSignatureValidation`, который отключает валидацию подписи токенов через стандратные механизмы ASP.NET Identity. \
  **Внимание!** При включении этого флага необходимо самостоятельно реализовать такую валидацию в `TEsiaEvents`.
